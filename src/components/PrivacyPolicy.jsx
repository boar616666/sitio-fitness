      ...
      return (
        <div className="privacy-policy-container">
          ...
          <div className="privacy-section">
            ...
            <p>Para ejercer estos derechos, escríbenos a: <a href="mailto:josueomarnunezgodinez@gmaiil.com">josueomarnunezgodinez@gmaiil.com</a>.</p>
          </div>
          ...
          <div className="privacy-section">
            <h2>10. Conservación y eliminación de datos (Principio de temporalidad)</h2>
            <p>
              Por motivos de seguridad y cumplimiento del principio de temporalidad, las cuentas de usuarios y entrenadores que permanezcan inactivas durante un periodo de 1 año serán eliminadas automáticamente junto con sus datos personales.<br />
              Esta eliminación no es definitiva: si en el futuro deseas volver a utilizar nuestros servicios, podrás registrarte nuevamente con tus datos.<br />
          ...
          <div className="privacy-contact">
            <h2>Contacto</h2>
            <p>Para dudas o ejercer derechos, escríbenos a: <a href="mailto:josueomarnunezgodinez@gmaiil.com">josueomarnunezgodinez@gmaiil.com</a> o llama al 4186903203.</p>
          </div>
        </div>
      );
    };
