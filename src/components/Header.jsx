    ...
    const checkLoginStatus = () => {
      ...
      if (userType && userNombre) {
        ...
        setUserData({
          ...
          foto: sessionStorage.getItem('foto') || 'https://img.freepik.com/foto-gratis/retrato-joven-sonriente-gafas_171337-4842.jpg'
        });
      } else {
        setIsLoggedIn(false);
        setUserData({});
            ...
            <div className="profile-menu-container" ref={profileMenuRef}>
              <div className="profile-button" onClick={toggleProfileMenu}>
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = 'https://img.freepik.com/foto-gratis/retrato-joven-sonriente-gafas_171337-4842.jpg';
                  }}
                />
                <span className="profile-name">{userData.nombre}</span>
                <span className={`profile-arrow ${isProfileMenuOpen ? 'up' : 'down'}`}>▼</span>
              </div>
                ...
                <div className="profile-dropdown-menu">
                  <div className="profile-dropdown-header">
                    ...
                    <div className="profile-dropdown-info">
                      ...
                      <p className="profile-dropdown-email">{userData.correo}</p>
                    </div>
                  </div>
                  ...
                  <ul className="profile-dropdown-options">
                    ...
                    <li>
                      <Link to="/mis-citas" onClick={() => setIsProfileMenuOpen(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
